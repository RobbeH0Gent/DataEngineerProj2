...
BEGIN
    UPDATE DW.dbo.DimContact
     SET 
        ...
        Status = rc.Status,
        Voka_medewerker = rc.Voka_mederwerker,
        Persoon_ID = rc.Persoon_ID,
        Functie_ID = rf.Functie_ID
        -- Gebruiker_ID = rg.Gebruiker_ID
    ...
    (Contact_ID, Account_ID, Functie_title, Status, Voka_mederwerker, Persoon_ID, Functie_ID)
    SELECT rc.Contactfiche_ID, rc.Account_ID, rc.Functie_title, rc.Status, rc.Voka_medewerker,  rc.Persoon_ID,  rf.Functie_ID
